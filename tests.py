...
def extract_model_info(file_name: str) -> tuple[str, str]:
    ...
    Args:
        file_name (str): The name of the file containing model information.
                         Handles various formats including special characters in model names.
    ...
    Examples:
        >>> file_name1 = "docato_titanic_survivability_prediction_model_20241022_165531.pkl"
        >>> extract_model_info(file_name1)
        ('Titanic Survivability Prediction Model', '2024-10-22 16:55:31')
        
        >>> file_name2 = "docato_wre_nexus_pipeline_-_claim_relevance_model_20241021_153632.pkl"
        >>> extract_model_info(file_name2)
