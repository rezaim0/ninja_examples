...
def create_model_review_checker(bucket_name: str, 
                               bucket_prefix: str = "",
                               table_name: str = "output") -> ModelReviewChecker:
    ...
    Args:
        ...
        table_name: Table identifier for database (config key like "output" or direct name).
        
    Returns:
        Configured ModelReviewChecker instance.
    """
    from database_repository import create_database_repository
    
    # Create repositories with updated approach
    db_repo = create_database_repository(table_name)
